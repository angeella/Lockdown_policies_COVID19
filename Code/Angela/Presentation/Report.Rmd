...
b$x$data[[5]]$marker$color <- b$x$data[[5]]$marker$line$color
...
cc$x$data[[4]]$marker$color <- cc$x$data[[4]]$marker$line$color
cc$x$data[[5]]$marker$color <- cc$x$data[[5]]$marker$line$color
